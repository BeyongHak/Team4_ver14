...
class Writer:
    ...
    def add(self, step, Avg_reward, reward, entropy, actor_loss, critic_loss, total_loss, mono_loss, kl_mean, kl_max, kl_min):
        """
        Overview: Add scalar values to Tensorboard for various training statistics.
        
        Arguments:
            step (int): Training step or iteration number.
            Avg_reward (float): Win rate value.
            ...
            mono_loss (float): Monotonicity loss value.
        ...
        """
        self.writer.add_scalar("A.Train/Avg reward", Avg_reward, step)
        ...
        self.writer.add_scalar("B.Loss/MonoLoss", mono_loss, step)
